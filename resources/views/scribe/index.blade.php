...
<head>
    ...
    <title>AppObras API Documentation</title>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/companies/10/invites" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"qkunze@example.com\",
...
<div class="bash-example">
    ...
    \"status\": \"in_progress\",
    \"archived_at\": \"2025-12-24T11:30:40\",
    \"start_date\": \"2025-12-24T11:30:40\",
    \"end_date\": \"2107-01-23\",
    \"actual_start_date\": \"2025-12-24T11:30:40\",
    \"actual_end_date\": \"2107-01-23\",
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2025-12-24T11:30:40"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-12-24T11:30:40</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start_date</code>. Example: <code>2107-01-23</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>actual_start_date</code>. Example: <code>2107-01-23</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/projects/5" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/projects/5"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/projects/5/phases" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/projects/5/phases"
);
...
<div class="bash-example">
    ...
    \"sequence\": 12,
    \"color\": \"#4CD4ab\",
    \"planned_start_at\": \"2025-12-24T11:30:40\",
    \"planned_end_at\": \"2107-01-23\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>planned_start_at</code>. Example: <code>2107-01-23</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"planned_start_at\": \"2025-12-24T11:30:40\",
    \"planned_end_at\": \"2107-01-23\",
    \"actual_start_at\": \"2025-12-24T11:30:40\",
    \"actual_end_at\": \"2025-12-24T11:30:40\"
}"
</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/projects/5/tasks" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/projects/5/tasks"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/projects/5/documents" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/projects/5/documents"
);
...
<div class="bash-example">
    ...
    --form "file=@/private/var/folders/1p/t__mjx8s4bl01p68ls9f79300000gn/T/php5VGjVo" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 10240 kilobytes. Example: <code>/private/var/folders/1p/t__mjx8s4bl01p68ls9f79300000gn/T/php5VGjVo</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/projects/5/progress" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/projects/5/progress"
);
