...
class StoreExpenseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // project_id não é necessário aqui, vem da URL (/projects/{project}/expenses)
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($this->input('status') === ExpenseStatus::approved->value) {
                if (! $this->hasFile('receipt') && ! $this->input('receipt_path')) {
    ...
    public function messages(): array
    {
        return [
            ...
            'status.required' => 'O status da despesa é obrigatório.',
